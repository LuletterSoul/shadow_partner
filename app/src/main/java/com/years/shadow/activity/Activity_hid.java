...
import com.years.shadow.core.Consts;
import com.years.shadow.core.events.LogMessageEvent;
import com.years.shadow.core.events.PrepareDevicesListEvent;
import com.years.shadow.core.events.SelectDeviceEvent;
import com.years.shadow.core.events.ShowDevicesListEvent;
import com.years.shadow.core.events.USBDataReceiveEvent;
import com.years.shadow.core.services.USBHIDService;

import de.greenrobot.event.EventBus;
import de.greenrobot.event.EventBusException;

/**
 * Created by zhumingqing on 2017/7/27.
 */

public class Activity_hid extends Activity implements View.OnClickListener{
...
//	}
    ...
    protected void onStart() {
        super.onStart();
        receiveDataFormat = Consts.HEXADECIMAL;
        prepareServices();
        setDelimiter();
...
//		}
        ...
        usbService.putExtra(Consts.RECEIVE_DATA_FORMAT, Consts.HEXADECIMAL);
        usbService.putExtra(Consts.DELIMITER, Consts.NEW_LINE);
        startService(usbService);
    }
